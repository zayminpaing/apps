...
FILE="$(ls /home/pi/Desktop/ZMP/HDB/AGGREGARE_LIVE | grep "$DATE")"
if [[ "$FILE" == *"$DATE"* ]]; then
    cp -r /home/pi/Desktop/ZMP/HDB/AGGREGARE_LIVE/"$FILE" /home/pi/Desktop/ZMP/HDB_HUAWEI/AGGREGARE_LIVE/
    echo Success,AGGREGARE_LIVE,$(date),$(ls -l --block-size=MB /home/pi/Desktop/ZMP/HDB/AGGREGARE_LIVE/"$FILE" | grep "total") >> /home/pi/Desktop/ZMP/HDB/temp_log.txt
    echo Success,AGGREGARE_LIVE,$(date),$(ls -l --block-size=MB /home/pi/Desktop/ZMP/HDB/AGGREGARE_LIVE/"$FILE" | grep "total") >> /home/pi/Desktop/ZMP/HDB/temp_success.txt
else
    echo Failed,AGGREGARE_LIVE,$(date) >> /home/pi/Desktop/ZMP/HDB/temp_log.txt
    echo Failed,AGGREGARE_LIVE,$(date) >> /home/pi/Desktop/ZMP/HDB/temp_failed.txt
fi
...
FILE="$(ls /home/pi/Desktop/ZMP/HDB/VILLAGE_LINK_V2 | grep "$DATE")"
if [[ "$FILE" == *"$DATE"* ]]; then
    cp -r /home/pi/Desktop/ZMP/HDB/VILLAGE_LINK_V2/"$FILE" /home/pi/Desktop/ZMP/HDB_HUAWEI/VILLAGE_LINK_V2/
    echo Success,VILLAGE_LINK_V2,$(date),$(ls -l --block-size=MB /home/pi/Desktop/ZMP/HDB/VILLAGE_LINK_V2/"$FILE" | grep "total") >> /home/pi/Desktop/ZMP/HDB/temp_log.txt
    echo Success,VILLAGE_LINK_V2,$(date),$(ls -l --block-size=MB /home/pi/Desktop/ZMP/HDB/VILLAGE_LINK_V2/"$FILE" | grep "total") >> /home/pi/Desktop/ZMP/HDB/temp_success.txt
else
    echo Failed,VILLAGE_LINK_V2,$(date) >> /home/pi/Desktop/ZMP/HDB/temp_log.txt
    echo Failed,VILLAGE_LINK_V2,$(date) >> /home/pi/Desktop/ZMP/HDB/temp_failed.txt
fi
